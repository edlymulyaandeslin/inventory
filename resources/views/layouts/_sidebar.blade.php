    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                <div class="mt-2 mb-2 ml-2 hr-text hr-text-left">Dashboard</div>
                @role('Customer')
                    <li class="nav-item">
                    ...
                    <div class="mt-2 mb-2 ml-2 hr-text hr-text-left">Menu</div>
                    <li class="nav-item">
                    ...
                    <div class="mt-2 mb-2 ml-2 hr-text hr-text-left">Transaksi</div>
                    <li class="nav-item">
                    ...
                    <div class="mt-2 mb-2 ml-2 hr-text hr-text-left">Konfigurasi</div>
                    <li class="nav-item">
                ...
                @hasanyrole('Admin|Super Admin')
                    ...
                    @endcan --}}
                    <div class="mt-2 mb-2 ml-2 hr-text hr-text-left">Stok Produk</div>
                    <li class="nav-item">
                    ...
                    <div class="mt-2 mb-2 ml-2 hr-text hr-text-left">User Manajemen</div>
                    <li class="nav-item">
